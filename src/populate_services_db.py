...
def populate():
    ...
    service_records = [
        ...
        {'description': 'Sealer - Lumiseal Plus', 'cost': .8, 'category': 'Sealer', 'measurement': 'square_foot',
         'protected': False},
        {'description': 'Steps', 'cost': 500, 'category': 'Steps', 'measurement': 'each', 'protected': False},
        {'description': 'Egress Window AAxBB', 'cost': 1400, 'category': 'Window', 'measurement': 'each',
         'protected': False},
        {'description': 'Fasteners', 'cost': 20, 'category': 'Fasteners', 'measurement': 'each', 'protected': False},
        {'description': 'Flashing', 'cost': 25, 'category': 'Flashing', 'measurement': 'each', 'protected': False},
