...
class CustomerForm(forms.ModelForm):
    ...
    email = forms.EmailField(max_length=128, required=False, help_text="Please enter the customer email address")
    telephone = forms.CharField(min_length=10, max_length=10, required=False,
                                help_text="Please enter the customer telephone number")
