    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Enter the customer email address', max_length=254)),
                ('telephone', models.CharField(help_text='Enter the customer telephone number', max_length=10)),
